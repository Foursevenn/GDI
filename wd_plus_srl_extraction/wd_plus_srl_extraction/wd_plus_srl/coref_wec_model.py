...
from wd_plus_srl_extraction.wd_plus_srl.coref_allen import evaluate_coref
from wd_plus_srl_extraction.wd_plus_srl.data.data_loader import IDataLoader
from wd_plus_srl_extraction.wd_plus_srl.data.io import create_if_not_exist
from wd_plus_srl_extraction.wd_plus_srl.wec_model.cluster import run_clustering, print_results, clean_and_save
from wd_plus_srl_extraction.wd_plus_srl.wec_model.generate_wec_predictions import generate_pairs_predictions
...
if __name__ == '__main__':
    ...
    print('Final results:', all_mentions)
