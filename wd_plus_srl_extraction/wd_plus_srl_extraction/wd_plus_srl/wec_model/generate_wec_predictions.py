...
import numpy as np
import torch
from wd_plus_srl_extraction.wd_plus_srl.dataobjs.mention_data import MentionData
from wd_plus_srl_extraction.utils.embed_utils import EmbedInMemory
...
def predict(model, mentions: List[MentionData]):
    ...
    print('Mention Head Pos:\n',[mention.mention_head_pos for mention in mentions],'\n')
...
def get_pairwise_model(model_file, mentions, use_cuda):
    ...
    if use_cuda:
        ...
        print('\nloading cpu\n')
        #pairwize_model.cuda=False
        pairwize_model.use_cuda = False
