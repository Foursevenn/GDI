...
from wd_plus_srl_extraction.wd_plus_srl.data.io import json_serialize_default, create_if_not_exist
from wd_plus_srl_extraction.wd_plus_srl.data.mention import Mention
...
def evaluate_coref(input_path: str, data_loader: IDataLoader) -> Tuple[List[Mention], List[Doc]]:
    ...
    for doc in documents:
        ...
        #print('Mention Result:\n',json.dumps(mention_result, default=json_serialize_default),'\n')
...
if __name__ == '__main__':
    ...
    coref_result, _ = evaluate_coref(args.input_file, dataloader)
